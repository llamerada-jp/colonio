...
extern "C" {
  ...
  EMSCRIPTEN_KEEPALIVE void js_connect(COLONIO_PTR_T colonio_ptr, COLONIO_PTR_T url, COLONIO_PTR_T token,
  ...
  EMSCRIPTEN_KEEPALIVE void js_map_set_value(COLONIO_PTR_T map_ptr, COLONIO_PTR_T key_ptr,
                                             COLONIO_PTR_T val_ptr, COLONIO_ID_T id, int opt);

  EMSCRIPTEN_KEEPALIVE void js_pubsub2d_init(COLONIO_PTR_T on_pubsub2d_pub_ptr, COLONIO_PTR_T on_pubsub2d_on_ptr);
  EMSCRIPTEN_KEEPALIVE void js_pubsub2d_publish(COLONIO_PTR_T pubsub2d_ptr, COLONIO_PTR_T name_ptr, unsigned int name_siz,
                                                double x, double y, double r, COLONIO_PTR_T val_ptr, COLONIO_ID_T id);
  EMSCRIPTEN_KEEPALIVE void js_pubsub2d_on(COLONIO_PTR_T pubsub2d_ptr, COLONIO_PTR_T name_ptr, unsigned int name_siz,
                                           COLONIO_ID_T id);
...
void js_connect(COLONIO_PTR_T colonio_ptr, COLONIO_PTR_T url, COLONIO_PTR_T token,
                COLONIO_PTR_T on_success, COLONIO_PTR_T on_failure) {
  colonio_t* colonio = reinterpret_cast<colonio_t*>(colonio_ptr);

  colonio_connect(reinterpret_cast<colonio_t*>(colonio_ptr),
...
COLONIO_PTR_T js_access_map(COLONIO_PTR_T colonio_ptr, COLONIO_PTR_T name) {
  ...
  if (map_cache.find(name_str) == map_cache.end()) {
    colonio_map_t handler = colonio_access_map(reinterpret_cast<colonio_t*>(colonio_ptr),
...
COLONIO_PTR_T js_access_pubsub2d(COLONIO_PTR_T colonio_ptr, COLONIO_PTR_T name) {
  ...
  if (pubsub2d_cache.find(name_str) == pubsub2d_cache.end()) {
    colonio_pubsub2d_t handler = colonio_access_pubsub2d(reinterpret_cast<colonio_t*>(colonio_ptr),
                                                   reinterpret_cast<const char*>(name));
...
void wrap_on_output_log(colonio_t* colonio_ptr, COLONIO_LOG_LEVEL level,
                        const char* message_ptr, unsigned int message_siz) {
  js_on_output_log(reinterpret_cast<COLONIO_PTR_T>(colonio_ptr),
                   static_cast<int>(level),
                   reinterpret_cast<COLONIO_PTR_T>(message_ptr),
                   message_siz - 1);
}
...
void wrap_on_debug_event(colonio_t* colonio_ptr, COLONIO_DEBUG_EVENT event,
                         const char* message_ptr, unsigned int message_siz) {
  js_on_debug_event(reinterpret_cast<COLONIO_PTR_T>(colonio_ptr),
...
void js_get_my_nid(COLONIO_PTR_T colonio_ptr, COLONIO_PTR_T nid_ptr) {
  colonio_get_my_nid(reinterpret_cast<colonio_t*>(colonio_ptr),
                  reinterpret_cast<char*>(nid_ptr));
}
...
void js_map_get_value(COLONIO_PTR_T map_ptr, COLONIO_PTR_T key_ptr, COLONIO_ID_T id) {
  ...
  colonio_map_get(map, key, reinterpret_cast<void*>(id),
               wrap_map_get_value_success, wrap_map_get_value_failure);
}

void wrap_map_set_value_success(colonio_map_t* map, void* ptr) {
  on_map_set(reinterpret_cast<COLONIO_ID_T>(ptr),
             COLONIO_MAP_FAILURE_REASON_NONE);
}
...
void js_map_set_value(COLONIO_PTR_T map_ptr, COLONIO_PTR_T key_ptr, COLONIO_PTR_T val_ptr, COLONIO_ID_T id, int opt) {
  ...
  colonio_map_set(map, key, val, reinterpret_cast<void*>(id),
               wrap_map_set_value_success, wrap_map_set_value_failure, opt);
}
...
void wrap_pubsub2d_publish_success(colonio_pubsub2d_t* pubsub2d, void* ptr) {
  on_pubsub2d_pub(reinterpret_cast<COLONIO_ID_T>(ptr),
...
void js_pubsub2d_publish(COLONIO_PTR_T pubsub2d_ptr, COLONIO_PTR_T name_ptr, unsigned int name_siz,
                         double x, double y, double r, COLONIO_PTR_T val_ptr, COLONIO_ID_T id) {
  colonio_pubsub2d_publish(reinterpret_cast<colonio_pubsub2d_t*>(pubsub2d_ptr),
                        reinterpret_cast<char*>(name_ptr), name_siz,
                        x, y, r,
                        reinterpret_cast<colonio_value_t*>(val_ptr),
                        reinterpret_cast<void*>(id),
                        wrap_pubsub2d_publish_success, wrap_pubsub2d_publish_failure);
}

void wrap_pubsub2d_on_subscriber(colonio_pubsub2d_t* pubsub2d, void* ptr, const colonio_value_t* value) {
  on_pubsub2d_on(reinterpret_cast<COLONIO_ID_T>(ptr),
                 reinterpret_cast<COLONIO_PTR_T>(value));
}

void js_pubsub2d_on(COLONIO_PTR_T pubsub2d_ptr, COLONIO_PTR_T name_ptr, unsigned int name_siz, COLONIO_ID_T id) {
  colonio_pubsub2d_on(reinterpret_cast<colonio_pubsub2d_t*>(pubsub2d_ptr),
                   reinterpret_cast<char*>(name_ptr), name_siz,
                   reinterpret_cast<void*>(id),
                   wrap_pubsub2d_on_subscriber);
}

void js_pubsub2d_off(COLONIO_PTR_T pubsub2d_ptr, COLONIO_PTR_T name_ptr, unsigned int name_siz) {
  colonio_pubsub2d_off(reinterpret_cast<colonio_pubsub2d_t*>(pubsub2d_ptr),
                    reinterpret_cast<char*>(name_ptr), name_siz);
}
