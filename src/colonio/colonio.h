...
#define COLONIO_MAP_OPTION_ERROR_WITHOUT_EXIST 0x1
  ...
  COLONIO_PUBLIC void colonio_connect(colonio_t* colonio, const char* url, const char* token,
  ...
  COLONIO_PUBLIC void colonio_set_on_output_log(colonio_t* colonio,
                                          void (*func)(colonio_t*, COLONIO_LOG_LEVEL, const char*, unsigned int));
  COLONIO_PUBLIC void colonio_set_on_debug_event(colonio_t* colonio,
                                           void (*func)(colonio_t*, COLONIO_DEBUG_EVENT, const char*, unsigned int));
  ...
  COLONIO_PUBLIC void colonio_map_get(colonio_map_t* map, const colonio_value_t* key, void* ptr,
  ...
  COLONIO_PUBLIC void colonio_map_set(colonio_map_t* map, const colonio_value_t* key, const colonio_value_t* value, void* ptr,
                                void (*on_success)(colonio_map_t* map, void* ptr),
                                void (*on_failure)(colonio_map_t* map, void* ptr, COLONIO_MAP_FAILURE_REASON reason),
                                int opt);

  COLONIO_PUBLIC void colonio_pubsub2d_publish(colonio_pubsub2d_t* pubsub2d, const char* name, unsigned int name_siz,
  ...
  COLONIO_PUBLIC void colonio_pubsub2d_on(colonio_pubsub2d_t* pubsub2d, const char* name, unsigned int name_siz, void* ptr,
