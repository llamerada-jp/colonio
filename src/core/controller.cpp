...
Controller::Controller(ControllerDelegate& delegate_) :
    logger(*this), delegate(delegate_), scheduler(*this, logger), context(logger, random, scheduler) {
...
void Controller::logger_on_output(Logger& logger, const std::string& json) {
