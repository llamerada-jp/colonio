...
void on_timer(uv_timer_t* handle) {
  db->publish("me", M_PI * 139.7604131 / 180.0, M_PI *  35.6858593 / 180.0, R_1M * 100,
              colonio::Value("hello"), [](){}, [](colonio::PubSub2DFailureReason) {});    
}
...
void connect_on_success(colonio::Colonio& colonio) {
  ...
  colonio.set_position(M_PI * 139.7604131 / 180.0,
                    M_PI *  35.6858593 / 180.0);

  db = &colonio.access_pubsub2d("");
  db->on("me", [](const colonio::Value& value) {
...
int main(int argc, char* argv[]) {
  ...
  mycolonio.connect("http://coloniodev:8080/colonio/core.json", "",
