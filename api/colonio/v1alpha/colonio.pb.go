...
type RaftConfig struct {
	...
	Command       RaftConfigCommand      `protobuf:"varint,4,opt,name=command,proto3,enum=api.colonio.v1alpha.RaftConfigCommand" json:"command,omitempty"`
...
func (x *RaftConfig) GetLastSequence() uint64 {
	if x != nil {
...
func (x *RaftConfig) GetCommand() RaftConfigCommand {
	...
	return RaftConfigCommand_RAFT_CONFIG_COMMAND_SET
}
...
func (x *RaftConfigResponse) GetLastSequence() uint64 {
	if x != nil {
		return x.LastSequence
	}
	return 0
...
const file_api_colonio_v1alpha_colonio_proto_rawDesc = "" +
	...
	"\bresponse\x18\x01 \x01(\fR\bresponse\"\xcf\x02\n" +
	"\n" +
	"RaftConfig\x12\x1d\n" +
	"\n" +
	...
	"\acommand\x18\x04 \x01(\x0e2&.api.colonio.v1alpha.RaftConfigCommandR\acommand\x12F\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1b.api.colonio.v1alpha.NodeIDR\x05value:\x028\x01\"t\n" +
	"\x12RaftConfigResponse\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12\x1a\n" +
	"\bsequence\x18\x02 \x01(\x04R\bsequence\x12#\n" +
	"\rlast_sequence\x18\x03 \x01(\x04R\flastSequence\"\xd6\x01\n" +
	"\x06Spread\x123\n" +
	...
	"\x11RaftConfigCommand\x12\x1b\n" +
	"\x17RAFT_CONFIG_COMMAND_SET\x10\x00B5Z3github.com/llamerada-jp/colonio/api/colonio/v1alphab\x06proto3"
