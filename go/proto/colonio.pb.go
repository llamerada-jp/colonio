...
func (x *PacketContent) GetMessagingSuccess() *MessagingSuccess {
	if x, ok := x.GetContent().(*PacketContent_MessagingSuccess); ok {
		return x.MessagingSuccess
	}
	return nil
}
...
func (x *PacketContent) GetKvsAcceptSuccess() *KvsAcceptSuccess {
	if x, ok := x.GetContent().(*PacketContent_KvsAcceptSuccess); ok {
		return x.KvsAcceptSuccess
	}
	return nil
}

func (x *PacketContent) GetKvsAcceptFailure() *KvsAcceptFailure {
	if x, ok := x.GetContent().(*PacketContent_KvsAcceptFailure); ok {
		return x.KvsAcceptFailure
	}
	return nil
}
...
func (x *PacketContent) GetKvsGetSuccess() *KvsGetSuccess {
	if x, ok := x.GetContent().(*PacketContent_KvsGetSuccess); ok {
		return x.KvsGetSuccess
	}
	return nil
}
...
func (x *PacketContent) GetKvsPrepareSuccess() *KvsPrepareSuccess {
	if x, ok := x.GetContent().(*PacketContent_KvsPrepareSuccess); ok {
		return x.KvsPrepareSuccess
	}
	return nil
}

func (x *PacketContent) GetKvsPrepareFailure() *KvsPrepareFailure {
	if x, ok := x.GetContent().(*PacketContent_KvsPrepareFailure); ok {
		return x.KvsPrepareFailure
	}
	return nil
}
...
func (x *PacketContent) GetKvsSetFailure() *KvsSetFailure {
	if x, ok := x.GetContent().(*PacketContent_KvsSetFailure); ok {
		return x.KvsSetFailure
	}
	return nil
}
...
func (x *PacketContent) GetSpreadFailure() *SpreadFailure {
	if x, ok := x.GetContent().(*PacketContent_SpreadFailure); ok {
		return x.SpreadFailure
	}
	return nil
}
...
type PacketContent_Routing struct {
	Routing *Routing `protobuf:"bytes,9,opt,name=routing,proto3,oneof"`
}

type PacketContent_Messaging struct {
	Messaging *Messaging `protobuf:"bytes,10,opt,name=messaging,proto3,oneof"`
}

type PacketContent_MessagingSuccess struct {
	MessagingSuccess *MessagingSuccess `protobuf:"bytes,11,opt,name=messaging_success,json=messagingSuccess,proto3,oneof"`
}

type PacketContent_KvsAccept struct {
	KvsAccept *KvsAccept `protobuf:"bytes,12,opt,name=kvs_accept,json=kvsAccept,proto3,oneof"`
}

type PacketContent_KvsAcceptSuccess struct {
	KvsAcceptSuccess *KvsAcceptSuccess `protobuf:"bytes,13,opt,name=kvs_accept_success,json=kvsAcceptSuccess,proto3,oneof"`
}

type PacketContent_KvsAcceptFailure struct {
	KvsAcceptFailure *KvsAcceptFailure `protobuf:"bytes,14,opt,name=kvs_accept_failure,json=kvsAcceptFailure,proto3,oneof"`
}

type PacketContent_KvsBalanceAcceptor struct {
	KvsBalanceAcceptor *KvsBalanceAcceptor `protobuf:"bytes,15,opt,name=kvs_balance_acceptor,json=kvsBalanceAcceptor,proto3,oneof"`
}

type PacketContent_KvsBalanceProposer struct {
	KvsBalanceProposer *KvsBalanceProposer `protobuf:"bytes,16,opt,name=kvs_balance_proposer,json=kvsBalanceProposer,proto3,oneof"`
}

type PacketContent_KvsGet struct {
	KvsGet *KvsGet `protobuf:"bytes,17,opt,name=kvs_get,json=kvsGet,proto3,oneof"`
}

type PacketContent_KvsGetSuccess struct {
	KvsGetSuccess *KvsGetSuccess `protobuf:"bytes,18,opt,name=kvs_get_success,json=kvsGetSuccess,proto3,oneof"`
}

type PacketContent_KvsHint struct {
	KvsHint *KvsHint `protobuf:"bytes,19,opt,name=kvs_hint,json=kvsHint,proto3,oneof"`
}

type PacketContent_KvsPrepare struct {
	KvsPrepare *KvsPrepare `protobuf:"bytes,20,opt,name=kvs_prepare,json=kvsPrepare,proto3,oneof"`
}

type PacketContent_KvsPrepareSuccess struct {
	KvsPrepareSuccess *KvsPrepareSuccess `protobuf:"bytes,21,opt,name=kvs_prepare_success,json=kvsPrepareSuccess,proto3,oneof"`
}

type PacketContent_KvsPrepareFailure struct {
	KvsPrepareFailure *KvsPrepareFailure `protobuf:"bytes,22,opt,name=kvs_prepare_failure,json=kvsPrepareFailure,proto3,oneof"`
}

type PacketContent_KvsSet struct {
	KvsSet *KvsSet `protobuf:"bytes,23,opt,name=kvs_set,json=kvsSet,proto3,oneof"`
}

type PacketContent_KvsSetFailure struct {
	KvsSetFailure *KvsSetFailure `protobuf:"bytes,24,opt,name=kvs_set_failure,json=kvsSetFailure,proto3,oneof"`
}

type PacketContent_Spread struct {
	Spread *Spread `protobuf:"bytes,25,opt,name=spread,proto3,oneof"`
}

type PacketContent_SpreadKnock struct {
	SpreadKnock *SpreadKnock `protobuf:"bytes,26,opt,name=spread_knock,json=spreadKnock,proto3,oneof"`
}

type PacketContent_SpreadRelay struct {
	SpreadRelay *SpreadRelay `protobuf:"bytes,27,opt,name=spread_relay,json=spreadRelay,proto3,oneof"`
}

type PacketContent_SpreadFailure struct {
	SpreadFailure *SpreadFailure `protobuf:"bytes,28,opt,name=spread_failure,json=spreadFailure,proto3,oneof"`
}
...
func (*PacketContent_MessagingSuccess) isPacketContent_Content() {}

func (*PacketContent_KvsAccept) isPacketContent_Content() {}

func (*PacketContent_KvsAcceptSuccess) isPacketContent_Content() {}

func (*PacketContent_KvsAcceptFailure) isPacketContent_Content() {}
...
func (*PacketContent_KvsGetSuccess) isPacketContent_Content() {}

func (*PacketContent_KvsHint) isPacketContent_Content() {}

func (*PacketContent_KvsPrepare) isPacketContent_Content() {}

func (*PacketContent_KvsPrepareSuccess) isPacketContent_Content() {}

func (*PacketContent_KvsPrepareFailure) isPacketContent_Content() {}

func (*PacketContent_KvsSet) isPacketContent_Content() {}

func (*PacketContent_KvsSetFailure) isPacketContent_Content() {}
...
func (*PacketContent_SpreadFailure) isPacketContent_Content() {}
...
func (x *Messaging) GetValue() *Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *MessagingSuccess) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessagingSuccess) ProtoMessage() {}

func (x *MessagingSuccess) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessagingSuccess.ProtoReflect.Descriptor instead.
func (*MessagingSuccess) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{21}
}

func (x *MessagingSuccess) GetResponse() *Value {
	if x != nil {
		return x.Response
	}
	return nil
...
type KvsAccept struct {
	...
	Key       *Value `protobuf:"bytes,5,opt,name=key,proto3" json:"key,omitempty"`
...
func (x *KvsAcceptSuccess) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KvsAcceptSuccess) ProtoMessage() {}

func (x *KvsAcceptSuccess) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KvsAcceptSuccess.ProtoReflect.Descriptor instead.
func (*KvsAcceptSuccess) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{23}
}

func (x *KvsAcceptSuccess) GetN() uint32 {
	if x != nil {
		return x.N
	}
	return 0
...
func (x *KvsAcceptSuccess) GetI() uint32 {
	if x != nil {
		return x.I
	}
	return 0
...
func (x *KvsAcceptFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KvsAcceptFailure) ProtoMessage() {}

func (x *KvsAcceptFailure) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KvsAcceptFailure.ProtoReflect.Descriptor instead.
func (*KvsAcceptFailure) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{24}
}

func (x *KvsAcceptFailure) GetN() uint32 {
	if x != nil {
		return x.N
	}
	return 0
...
func (x *KvsAcceptFailure) GetI() uint32 {
	if x != nil {
		return x.I
	}
	return 0
...
func (x *KvsBalanceAcceptor) GetKey() *Value {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *KvsBalanceProposer) GetKey() *Value {
	if x != nil {
		return x.Key
	}
	return nil
...
type KvsGet struct {
	...
	Key       *Value `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
}
...
func (x *KvsGetSuccess) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KvsGetSuccess) ProtoMessage() {}

func (x *KvsGetSuccess) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KvsGetSuccess.ProtoReflect.Descriptor instead.
func (*KvsGetSuccess) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{28}
}

func (x *KvsGetSuccess) GetN() uint32 {
	if x != nil {
		return x.N
	}
	return 0
...
func (x *KvsGetSuccess) GetI() uint32 {
	if x != nil {
		return x.I
	}
	return 0
...
func (x *KvsGetSuccess) GetValue() *Value {
	if x != nil {
		return x.Value
	}
	return nil
...
type KvsPrepare struct {
	...
	Key       *Value `protobuf:"bytes,4,opt,name=key,proto3" json:"key,omitempty"`
}
...
func (x *KvsPrepare) GetKey() *Value {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *KvsPrepareSuccess) Reset() {
	*x = KvsPrepareSuccess{}
	if protoimpl.UnsafeEnabled {
...
func (x *KvsPrepareSuccess) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KvsPrepareSuccess) ProtoMessage() {}

func (x *KvsPrepareSuccess) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KvsPrepareSuccess.ProtoReflect.Descriptor instead.
func (*KvsPrepareSuccess) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{31}
}

func (x *KvsPrepareSuccess) GetN() uint32 {
	if x != nil {
		return x.N
	}
	return 0
...
func (x *KvsPrepareSuccess) GetI() uint32 {
	if x != nil {
		return x.I
	}
	return 0
...
func (x *KvsPrepareFailure) Reset() {
	*x = KvsPrepareFailure{}
	if protoimpl.UnsafeEnabled {
...
func (x *KvsPrepareFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KvsPrepareFailure) ProtoMessage() {}

func (x *KvsPrepareFailure) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KvsPrepareFailure.ProtoReflect.Descriptor instead.
func (*KvsPrepareFailure) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{32}
}

func (x *KvsPrepareFailure) GetN() uint32 {
	if x != nil {
		return x.N
	}
	return 0
...
func (x *KvsSetFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KvsSetFailure) ProtoMessage() {}

func (x *KvsSetFailure) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KvsSetFailure.ProtoReflect.Descriptor instead.
func (*KvsSetFailure) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{34}
}

func (x *KvsSetFailure) GetReason() uint32 {
	if x != nil {
		return x.Reason
	}
	return 0
...
func (x *SpreadRelay) GetValue() *Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *SpreadFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpreadFailure) ProtoMessage() {}

func (x *SpreadFailure) ProtoReflect() protoreflect.Message {
	mi := &file_colonio_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpreadFailure.ProtoReflect.Descriptor instead.
func (*SpreadFailure) Descriptor() ([]byte, []int) {
	return file_colonio_proto_rawDescGZIP(), []int{38}
}

func (x *SpreadFailure) GetReason() uint32 {
	if x != nil {
		return x.Reason
	}
	return 0
...
var file_colonio_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xe8, 0x0d, 0x0a, 0x0d, 0x50,
	...
	0x69, 0x6e, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63, 0x6f, 0x6c, 0x6f,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4a, 0x0a, 0x0c, 0x6e, 0x6f, 0x64, 0x65, 0x5f,
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e,
	0x63, 0x6f, 0x6c, 0x6f, 0x6e, 0x69, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x6f,
	0x75, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x6e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x73, 0x1a, 0x60, 0x0a, 0x10, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72,
	...
	,
	...
	0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x2e, 0x0a, 0x10, 0x4b, 0x76, 0x73,
	0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x0c, 0x0a,
	0x01, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x6e, 0x12, 0x0c, 0x0a, 0x01, 0x69,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x69, 0x22, 0x2e, 0x0a, 0x10, 0x4b, 0x76, 0x73,
	0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x0c, 0x0a,
	0x01, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x6e, 0x12, 0x0c, 0x0a, 0x01, 0x69,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x69, 0x22, 0xb7, 0x01, 0x0a, 0x12, 0x4b, 0x76,
	...
	0x26, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63,
	0x6f, 0x6c, 0x6f, 0x6e, 0x69, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x2a, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	...
	0x6c, 0x75, 0x65, 0x22, 0x88, 0x01, 0x0a, 0x12, 0x4b, 0x76, 0x73, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x70, 0x12, 0x26, 0x0a, 0x03, 0x6b, 0x65,
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x6f, 0x6c, 0x6f, 0x6e, 0x69,
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x03, 0x6b,
	...
	,
	...
	,
	...
	,
	...
	0x4b, 0x76, 0x73, 0x53, 0x65, 0x74, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x16, 0x0a,
	0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x72,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xad, 0x01, 0x0a, 0x06, 0x53, 0x70, 0x72, 0x65, 0x61, 0x64,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x6f, 0x6c, 0x6f, 0x6e, 0x69, 0x6f,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6f, 0x70, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d,
	...
	0x28, 0x04, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0xb2, 0x01, 0x0a, 0x0b, 0x53, 0x70, 0x72, 0x65,
	0x61, 0x64, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x12, 0x31, 0x0a, 0x06, 0x63, 0x65, 0x6e, 0x74, 0x65,
	...
	0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	,
...
var file_colonio_proto_goTypes = []interface{}{
	...
	(*MessagingSuccess)(nil),      // 21: colonio.proto.MessagingSuccess
	(*KvsAccept)(nil),             // 22: colonio.proto.KvsAccept
	(*KvsAcceptSuccess)(nil),      // 23: colonio.proto.KvsAcceptSuccess
	(*KvsAcceptFailure)(nil),      // 24: colonio.proto.KvsAcceptFailure
	...
	(*KvsGetSuccess)(nil),         // 28: colonio.proto.KvsGetSuccess
	(*KvsHint)(nil),               // 29: colonio.proto.KvsHint
	(*KvsPrepare)(nil),            // 30: colonio.proto.KvsPrepare
	(*KvsPrepareSuccess)(nil),     // 31: colonio.proto.KvsPrepareSuccess
	(*KvsPrepareFailure)(nil),     // 32: colonio.proto.KvsPrepareFailure
	(*KvsSet)(nil),                // 33: colonio.proto.KvsSet
	(*KvsSetFailure)(nil),         // 34: colonio.proto.KvsSetFailure
	...
	(*SpreadFailure)(nil),         // 38: colonio.proto.SpreadFailure
...
var file_colonio_proto_depIdxs = []int32{
	...
	21, // 19: colonio.proto.PacketContent.messaging_success:type_name -> colonio.proto.MessagingSuccess
	22, // 20: colonio.proto.PacketContent.kvs_accept:type_name -> colonio.proto.KvsAccept
	23, // 21: colonio.proto.PacketContent.kvs_accept_success:type_name -> colonio.proto.KvsAcceptSuccess
	24, // 22: colonio.proto.PacketContent.kvs_accept_failure:type_name -> colonio.proto.KvsAcceptFailure
	25, // 23: colonio.proto.PacketContent.kvs_balance_acceptor:type_name -> colonio.proto.KvsBalanceAcceptor
	26, // 24: colonio.proto.PacketContent.kvs_balance_proposer:type_name -> colonio.proto.KvsBalanceProposer
	27, // 25: colonio.proto.PacketContent.kvs_get:type_name -> colonio.proto.KvsGet
	28, // 26: colonio.proto.PacketContent.kvs_get_success:type_name -> colonio.proto.KvsGetSuccess
	29, // 27: colonio.proto.PacketContent.kvs_hint:type_name -> colonio.proto.KvsHint
	30, // 28: colonio.proto.PacketContent.kvs_prepare:type_name -> colonio.proto.KvsPrepare
	31, // 29: colonio.proto.PacketContent.kvs_prepare_success:type_name -> colonio.proto.KvsPrepareSuccess
	32, // 30: colonio.proto.PacketContent.kvs_prepare_failure:type_name -> colonio.proto.KvsPrepareFailure
	33, // 31: colonio.proto.PacketContent.kvs_set:type_name -> colonio.proto.KvsSet
	34, // 32: colonio.proto.PacketContent.kvs_set_failure:type_name -> colonio.proto.KvsSetFailure
	35, // 33: colonio.proto.PacketContent.spread:type_name -> colonio.proto.Spread
	36, // 34: colonio.proto.PacketContent.spread_knock:type_name -> colonio.proto.SpreadKnock
	37, // 35: colonio.proto.PacketContent.spread_relay:type_name -> colonio.proto.SpreadRelay
	38, // 36: colonio.proto.PacketContent.spread_failure:type_name -> colonio.proto.SpreadFailure
	1,  // 37: colonio.proto.SeedAuth.nid:type_name -> colonio.proto.NodeID
	1,  // 38: colonio.proto.SignalingICE.local_nid:type_name -> colonio.proto.NodeID
	1,  // 39: colonio.proto.SignalingICE.remote_nid:type_name -> colonio.proto.NodeID
	1,  // 40: colonio.proto.SignalingOffer.prime_nid:type_name -> colonio.proto.NodeID
	1,  // 41: colonio.proto.SignalingOffer.second_nid:type_name -> colonio.proto.NodeID
	1,  // 42: colonio.proto.SignalingOfferSuccess.second_nid:type_name -> colonio.proto.NodeID
	1,  // 43: colonio.proto.SignalingOfferFailure.prime_nid:type_name -> colonio.proto.NodeID
	1,  // 44: colonio.proto.RoutingSeedRecord.nid:type_name -> colonio.proto.NodeID
	0,  // 45: colonio.proto.RoutingNodeRecord.r2d_position:type_name -> colonio.proto.Coordinate
	17, // 46: colonio.proto.Routing.seed_records:type_name -> colonio.proto.RoutingSeedRecord
	0,  // 47: colonio.proto.Routing.r2d_position:type_name -> colonio.proto.Coordinate
	39, // 48: colonio.proto.Routing.node_records:type_name -> colonio.proto.Routing.NodeRecordsEntry
	2,  // 49: colonio.proto.Messaging.value:type_name -> colonio.proto.Value
	2,  // 50: colonio.proto.MessagingSuccess.response:type_name -> colonio.proto.Value
	2,  // 51: colonio.proto.KvsAccept.key:type_name -> colonio.proto.Value
	2,  // 52: colonio.proto.KvsAccept.value:type_name -> colonio.proto.Value
	2,  // 53: colonio.proto.KvsBalanceAcceptor.key:type_name -> colonio.proto.Value
	2,  // 54: colonio.proto.KvsBalanceAcceptor.value:type_name -> colonio.proto.Value
	2,  // 55: colonio.proto.KvsBalanceProposer.key:type_name -> colonio.proto.Value
	2,  // 56: colonio.proto.KvsBalanceProposer.value:type_name -> colonio.proto.Value
	2,  // 57: colonio.proto.KvsGet.key:type_name -> colonio.proto.Value
	2,  // 58: colonio.proto.KvsGetSuccess.value:type_name -> colonio.proto.Value
	2,  // 59: colonio.proto.KvsHint.key:type_name -> colonio.proto.Value
	2,  // 60: colonio.proto.KvsHint.value:type_name -> colonio.proto.Value
	2,  // 61: colonio.proto.KvsPrepare.key:type_name -> colonio.proto.Value
	2,  // 62: colonio.proto.KvsSet.key:type_name -> colonio.proto.Value
	2,  // 63: colonio.proto.KvsSet.value:type_name -> colonio.proto.Value
	0,  // 64: colonio.proto.Spread.center:type_name -> colonio.proto.Coordinate
	2,  // 65: colonio.proto.Spread.value:type_name -> colonio.proto.Value
	0,  // 66: colonio.proto.SpreadKnock.center:type_name -> colonio.proto.Coordinate
	0,  // 67: colonio.proto.SpreadRelay.center:type_name -> colonio.proto.Coordinate
	2,  // 68: colonio.proto.SpreadRelay.value:type_name -> colonio.proto.Value
	18, // 69: colonio.proto.Routing.NodeRecordsEntry.value:type_name -> colonio.proto.RoutingNodeRecord
...
func file_colonio_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_colonio_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KvsPrepareSuccess); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_colonio_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KvsPrepareFailure); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
