...
type Gateway interface {
	...
	UpdateNodeTimestamp(ctx context.Context, nodeID *shared.NodeID) error
...
func NewSimpleGateway(handler Handler) Gateway {
...
func (h *SimpleGateway) UpdateNodeTimestamp(_ context.Context, nodeID *shared.NodeID) error {
	h.mtx.Lock()
	defer h.mtx.Unlock()
