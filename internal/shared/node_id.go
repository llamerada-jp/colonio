...
// NewHashedNodeID returns a new NodeID generated by hashing the given byte slice.
// The hashing algorithm used is xxh3 128-bit.
func NewHashedNodeID(src []byte) *NodeID {
	hash := xxh3.Hash128(src)
