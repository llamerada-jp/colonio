...
func (n *node) appendNode(sequence uint64, nodeID *shared.NodeID) {
	panic("appendNode not implemented")
}

func (n *node) removeNode(sequence uint64) {
	panic("removeNode not implemented")
}
