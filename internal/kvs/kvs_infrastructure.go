...
type KvsInfrastructure interface {
	...
	sendSectorConfig(param *sectorConfigParam)
}
...
func (i *kvsInfrastructureImpl) sendSectorConfig(param *sectorConfigParam) {
	...
	i.transferer.RequestOneWay(
		...
		&proto.PacketContent{
			Content: &proto.PacketContent_SectorConfig{
				SectorConfig: &proto.SectorConfig{
					SectorId: sector.MustMarshalSectorID(param.sectorID),
